...
function Orders() {
  ...
  return (
    <div className="p-6 w-full max-w-[100vw] bg-gray-100 dark:bg-gray-900">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4 mb-4 w-full">
          ...
          <div className="relative w-full" ref={storeRef}>
            ...
            >
              ...
              <FaChevronDown className="absolute right-3 text-gray-400" />
            </div>
            {storeOpen && (
          ...
          <div className="relative w-full" ref={statusRef}>
            ...
            >
              <FaCar className="absolute left-3 text-gray-400" />
        ...
        <div className="w-full overflow-x-auto border border-gray-200 dark:border-gray-700 rounded-lg">
          <table className="w-full min-w-[600px] text-sm">
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                <th className="p-3 text-left border-b border-gray-200 dark:border-gray-600 cursor-pointer">
